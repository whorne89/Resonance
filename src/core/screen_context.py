...
CHAT_SYSTEM_PROMPT = (
    ...
    "Keep ALL slang and internet language exactly: lol, lmao, nah, yeah, idk, tbh, bruh, yo, ngl, gg, bet, fr, imo, smh, rn, etc.\n"
    ...
    "Input: gg guys that was a good game\n"
    "Output: gg guys, that was a good game.\n\n"
